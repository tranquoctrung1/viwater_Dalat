<%@ control language="C#" autoeventwireup="true" inherits="_controls_upload_meter, App_Web_b52rb5rr" %>
<style type="text/css">
    .auto-style1 {
        width: 100%;
    }
...
<table class="auto-style1">
    ...
    <tr>
        <td>Chọn file</td>
        <td>
            <telerik:RadAsyncUpload ID="updM" runat="server">
    ...
    <tr>
        <td>&nbsp;</td>
        <td>
            <telerik:RadButton ID="btnMUploadFile" runat="server" Text="Upload">
            </telerik:RadButton>
            <telerik:RadButton ID="btnMDownloadFile" runat="server" Text="Download">
            </telerik:RadButton>
            <telerik:RadButton ID="btnMDeleteFile" runat="server" Text="Xóa file">
            </telerik:RadButton>
        </td>
    </tr>
</table>
<telerik:RadGrid ID="grvMFiles" runat="server" CellSpacing="0" DataSourceID="MFilesDS" GridLines="None" AllowPaging="True" AllowSorting="True" AutoGenerateDeleteColumn="True">
    <ClientSettings AllowColumnsReorder="True" ReorderColumnsOnClient="True">
    </ClientSettings>
<MasterTableView AutoGenerateColumns="False" DataSourceID="MFilesDS">
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        ...
        <telerik:GridBoundColumn DataField="Size" FilterControlAltText="Filter Size column" HeaderText="Dung lượng" SortExpression="Size" UniqueName="Size" DataType="System.Int32">
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn DataField="UploadDate" FilterControlAltText="Filter UploadDate column" HeaderText="Ngày upload" SortExpression="UploadDate" UniqueName="UploadDate" DataType="System.DateTime">
        </telerik:GridBoundColumn>
    </Columns>
...
<asp:SqlDataSource ID="MFilesDS" runat="server" ConnectionString="<%$ ConnectionStrings:DbConnectionString %>" SelectCommand="SELECT [FileName], [MIMEType], [Size], [UploadDate] FROM [t_Meter_Files] WHERE ([MeterSerial] = @MeterSerial) ORDER BY [UploadDate], [FileName]">
    <SelectParameters>
        <asp:ControlParameter ControlID="cboMSeries" Name="MeterSerial" PropertyName="SelectedValue" Type="String" />
    </SelectParameters>
</asp:SqlDataSource>
