<%@ page title="" language="C#" masterpagefile="~/Supervisor/MasterPage.master" autoeventwireup="true" inherits="Supervisor_Admin_CreateUser, App_Web_ayfbeluo" theme="Default" %>
    ...
    <div id="main">
        <div id="grid_2_columns">
            <ul class="multiple_columns">
                <li class="text_grid_2_columns">Ký danh:
                </li>
                ...
                <li class="text_grid_2_columns">Mật khẩu:
                </li>
                <li class="control_grid_2_columns">
                ...
                <li class="text_grid_2_columns">Quyền:
                </li>
                <li class="control_grid_2_columns">
                    <telerik:RadComboBox ID="cboRoles" runat="server" 
                        ...
                        <HeaderTemplate>
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="width:75px">Quyền</td>
                                    <td style="width:175px">Mô tả</td>
                                </tr>
                            </table>
                        </HeaderTemplate>
                        <ItemTemplate>
                ...
                <li class="text_grid_2_columns">
                    <asp:LinkButton ID="btnAddStaff" runat="server" CausesValidation="False" 
                        onclientclick="btnAddStaff_Click();return false;">Mã nhân viên:</asp:LinkButton>
                </li>
                <li class="control_grid_2_columns">
                    <telerik:RadComboBox ID="cboStaffs" runat="server" 
                        ...
                        <HeaderTemplate>
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="width:100px">Mã NV
                                    </td>
                                    <td style="width:75px">Tên
                                    </td>
                                    <td style="width:150px">Họ
                                    </td>
                                </tr>
                            </table>
                        </HeaderTemplate>
