...
<%@ page title="" language="C#" masterpagefile="~/Supervisor/MasterPage.master" autoeventwireup="true" inherits="Supervisor_ManualData_Change, App_Web_pbfu3lyk" theme="Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <%--<div id="title" style="height:67px">
        <div id="title_name">Sửa dữ liệu nhập tay</div>
        <div id="title_panel">
            <ul class="multiple_columns">
                ...
                <li class="text_grid_5_columns">Đến ngày:
                </li>
                <li class="control_grid_5_columns">
                </li>
                <li class="text_grid_5_columns">
