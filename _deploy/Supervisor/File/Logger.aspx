<%@ page title="" language="C#" masterpagefile="~/Empty.master" autoeventwireup="true" inherits="Supervisor_File_Logger, App_Web_ox5zq5ra" theme="Default" %>
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        ...
        <telerik:GridBoundColumn DataField="LoggerSerial" 
            FilterControlAltText="Filter column1 column" HeaderText="Số seri logger" 
            UniqueName="column1">
        </telerik:GridBoundColumn>
