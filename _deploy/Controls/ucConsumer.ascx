<%@ control language="C#" autoeventwireup="true" inherits="Controls_ucConsumer, App_Web_dmjolkrd" %>
<div>
    <div id="popup_panel">
        <ul class="multiple_columns">
            <li class="text_grid_2_columns">Mã khách hàng:
            </li>
            ...
            <li class="text_grid_2_columns">Khách hàng:
            </li>
            <li class="control_grid_2_columns">
