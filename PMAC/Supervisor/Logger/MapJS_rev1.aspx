                            ...
                            <div class="sidebar-container">
                                ...
                                <nav class="menu">
                                    <ul class="sidebar-menu metismenu" id="sidebar-menu">
                                        ...
                                        <li>
                                            <a href="/Supervisor/Logger/TableDetailLoggerNP.aspx" class="privilege">
                                                <i class="fa fa-table"></i>
                                                <asp:Label ID="lbTableDetailLoggerNP" runat="server" Text="Bảng dữ liệu chi tiết"></asp:Label>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/Supervisor/Logger/tableScada.aspx" class="privilege">
                                                <i class="fa fa-table"></i>
                                                <asp:Label ID="lbTableScada" runat="server" Text="Bảng dữ liệu"></asp:Label>
                                            </a>
                                        </li>
                                        <li>
                                            ...
                                            <ul class="sidebar-nav">
                                                ...
                                                <li>
                                                    <a href="/Supervisor/Logger/DataViewer.aspx">
                                                        <asp:Label ID="lbDataViewer" runat="server" Text="Dữ liệu Online"></asp:Label>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                ...
                //]]>
                                ...
                                <script type="text/javascript" id="telerikClientEvents2">
                                    ...
                                    function btnUpdateChart_Clicked(sender, args) {
                                        ...
                                        updateChart(toOADate(cDtStart.get_selectedDate()).toString().replace('.', '_'), toOADate(cDtEnd.get_selectedDate()).toString().replace('.', '_'));
                                        return false;
                                    }
                                            ...
                                            $.each(ds.GetSitesByUidResult, async function (i, s) {
                                                ...
                                                $.getJSON(url, function (dc) {
                                                    ...
                                                    if (s.Latitude != null && s.Latitude != undefined && s.Latitude.toString().trim() != "" && s.Longitude != null && s.Longitude != undefined && s.Longitude.toString().trim() != "") {
                                                        ...
                                                        let popUp = new L.Popup({ autoClose: false, closeOnClick: false, offset: [-6, 8] })
                                                            .setContent(infoHtml)
