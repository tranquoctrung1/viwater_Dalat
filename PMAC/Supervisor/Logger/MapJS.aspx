<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MapJS.aspx.cs" Inherits="Supervisor_Logger_MapJS" %>
    ...
    <script type="text/javascript">
        ...
        function getLs(msg1) {
            ...
            for (var post1 in msg1) {
                ...
                if (msg1[post1].Unit == "m" || msg1[post1].Unit == "bar") {
        ...
        function createWin(msg) {
            ...
            if (flag == false) {
                ...
                for (var i = 0; i < labelMarkers.length; i++) {
                    ...
                    node.set_text(msg[i].SiteAliasName);
                    node.set_value(msg[i].SiteAliasName);
