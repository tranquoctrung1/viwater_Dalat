...
public partial class Supervisor_Logger_Complex_TA : System.Web.UI.Page
{
    ...
    private void repTest_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        var var8 = list.Where(x => x.ControlId.Contains("lbForwardIndex")).FirstOrDefault();
        if (lblHeader != null)
        {
    ...
    private DataTable GetDataTable()
    {
        ...
        {
            dtItems = ToDataTable<ComplexData>(complexDataRepository.GetCustomComplexData().ToList());
        }
        else
        {
            //perform search and display results            
            dtItems = ToDataTable<ComplexData>(complexDataRepository.GetCustomComplexDataRange(
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Supervisor/Logger/Complex_TA.aspx?srch=" + searchText);
    }
