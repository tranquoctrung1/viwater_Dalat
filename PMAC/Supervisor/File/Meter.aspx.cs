...
public partial class Supervisor_File_Meter : System.Web.UI.Page
{
    StringUT _stringUT = new StringUT();
    FileUT _fileUT = new FileUT();
    MeterFileBL _meterFileBL = new MeterFileBL();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            string meter = Request.QueryString["meter"];
            txtSerial.Text = meter;
            BindFile();
        }
    ...
    {
        grv.DataSource = _meterFileBL.GetMeterFilesByMeterSerial(txtSerial.Text);
        grv.DataBind();
    }
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                var f = _meterFileBL.GetMeterFile(fileName);
                _meterFileBL.DeleteMeterFile(f);
            }
