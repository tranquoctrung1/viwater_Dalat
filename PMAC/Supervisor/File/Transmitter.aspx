<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.master" AutoEventWireup="true" CodeFile="Transmitter.aspx.cs" Inherits="Supervisor_File_Transmitter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="style1">
        <tr>
            <td>
                <asp:Label ID="winLinkUpload_MeterSeri" runat="server" Text="Số seri bộ hiển thị"></asp:Label>:
            </td>
            <td>
