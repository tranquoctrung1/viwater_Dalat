<%@ Page Title="" Language="C#" MasterPageFile="~/Supervisor/MasterPage.master" AutoEventWireup="true" CodeFile="ViewUsers.aspx.cs" Inherits="Supervisor_Admin_ViewUsers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2>
        <asp:Label ID="lbTitle" runat="server" Text="Xem người dùng"></asp:Label>
    </h2>
    <div id="main">
        <div id="view_user_filter_wrapper">
    <ul class="multiple_columns" >
        <li class="text_view_user_filter">
            <asp:Label ID="lbFilter" runat="server" Text="Lọc theo mã khách hàng"></asp:Label>: 
        </li>
...
<script type="text/javascript">
    $(function () {
        $("#ctl00_ContentPlaceHolder1_RadGrid1").css("width", "100%");
        $("#ctl00_ContentPlaceHolder1_RadGrid1").css("overflow-x", "auto");
    })
</script>
