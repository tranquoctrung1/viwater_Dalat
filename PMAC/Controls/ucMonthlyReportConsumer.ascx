<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucMonthlyReportConsumer.ascx.cs" Inherits="Controls_ucMontlyReportConsumer" %>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" BackColor="White"></DatePopupButton>
            ...
            <tr>
                <td><asp:Label ID="lbLocation" runat="server" Text="Vị trí"></asp:Label>:</td>
                <td>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" BackColor="White"></DatePopupButton>
    ...
    <script type="text/javascript">
        function ShowChartFormMonthly(si, dt, uid, rowIndex) {
