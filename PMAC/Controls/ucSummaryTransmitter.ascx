<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucSummaryTransmitter.ascx.cs" Inherits="Controls_ucSummaryTransmitter" %>
<style type="text/css">
    .style1
    {
        width: 100%;
...
<div class="tab_content">
    ...
    <table class="style1">
        <tr align="center">
            ...
            <td align="left" valign="top">
                <asp:Label ID="lbSize" runat="server" Text="Cỡ"></asp:Label></td>
            <td align="left" valign="top">
        ...
        <tr>
            ...
            <td align="left" valign="top">
                <asp:CheckBoxList ID="chkListSizes" runat="server" DataSourceID="SizeDataSource">
                </asp:CheckBoxList>
...
<HeaderStyle Width="20px"></HeaderStyle>
    ...
    <Columns>
        ...
        <telerik:GridBoundColumn DataField="Size" 
            FilterControlAltText="Filter column4 column" HeaderText="Cỡ" 
            UniqueName="column4">
        </telerik:GridBoundColumn>
