<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucLogger.ascx.cs" Inherits="Controls_ucLogger" %>
    ...
    <ul class="multiple_columns">
                    ...
                    <table cellpadding="0" cellspacing="0" style="width:420px">
                         <tr>
                            <td style="width: 160px">
                                 <asp:Label ID="seri_header" runat="server" Text="Seri"></asp:Label>
                             </td>
                             <td style="width: 60px">
                                 <asp:Label ID="manufacturer_header" runat="server" Text="Manufacturer"></asp:Label>
                             </td>
                             <td style="width: 100px">
                                 <asp:Label ID="brandname_header" runat="server" Text="Brand name"></asp:Label>
                             </td>
                             <td style="width: 50px">
                                 <asp:Label ID="size_header" runat="server" Text="Size"></asp:Label>
                             </td>
                        </tr>
                    </table>
        ...
        <li class="text_grid_4_columns">
            <asp:LinkButton ID="lnkUpload" runat="server" 
                onclientclick="lnkFileLogger_Clicked(); return false;">
                <asp:Label ID="lbUpload" runat="server" Text="Up/Down tài liệu logger"></asp:Label>
            </asp:LinkButton>
        </li>
        <li class="control_grid_4_columns">
...
<DatePopupButton ImageUrl="" HoverImageUrl=""></DatePopupButton>
        ...
        <li class="text_grid_4_columns">
            <asp:Label ID="lbBrand" runat="server" Text="Hiệu"></asp:Label>:
        </li>
        <li class="control_grid_4_columns">
        ...
        <telerik:RadWindow ID="winConfirmDeleteLogger" runat="server"  
            ...
            <ContentTemplate>
                <div style="text-align:center;padding:10px;">
                    <asp:Label ID="lb_delete_confirm" runat="server" Text="Bạn có chắc chắn muốn xóa dữ liệu logger"></asp:Label>
                </div>
                <div style="text-align:center;padding:10px;">
