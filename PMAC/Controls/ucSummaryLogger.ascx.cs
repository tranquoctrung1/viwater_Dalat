...
public partial class Controls_ucSummaryLogger : System.Web.UI.UserControl
{
    ...
    {
        grv.DataSource = _loggerBL.GetLoggerByConds(GetProviders(),
            GetMarks(),
            GetModels(),
            GetStatus(),
            GetInstalleds()
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            grv.ExportSettings.FileName = "Logger";
