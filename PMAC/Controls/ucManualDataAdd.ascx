<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucManualDataAdd.ascx.cs" Inherits="Controls_ucManualDataAdd" %>

            <div class="row">
                <div class="col-sm-1"><asp:Label ID="lbAliasName" runat="server" Text="Mã vị trí"></asp:Label>:</div>
                <div class="col-sm-3">
