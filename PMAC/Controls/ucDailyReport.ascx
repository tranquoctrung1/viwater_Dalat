<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucDailyReport.ascx.cs" Inherits="Controls_ucDailyReport" %>
<table style="width:900px">
        <tr>
            ...
            <td><asp:Label ID="lbFrom" runat="server" Text="Từ ngày"></asp:Label>:</td>
            <td>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" ForeColor="White" BackColor="White"></DatePopupButton>
        ...
        <tr>
            ...
            <td><asp:Label ID="lbTo" runat="server" Text="Đến ngày"></asp:Label>:</td>
            <td>
