...
public partial class Controls_ucSummaryTransmitter : System.Web.UI.UserControl
{
    ...
    {
        grv.DataSource=_transmitterBL.GetTransmitterByConds(GetProviders(),
            GetMarks(),
            GetSizes(),
            GetModels(),
            GetStatus(),
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            grv.ExportSettings.FileName = "Bộ hiển thị";
