<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucManualDataChange.ascx.cs" Inherits="Controls_ucManualDataChange" %>
...
<div class="row">
    <div class="col-sm-1">
        <asp:Label ID="lbAliasName" runat="server" Text="Mã vị trí"></asp:Label>:</div>
    <div class="col-sm-3">
            ...
            <telerik:RadWindow ID="winConfirmDelete" runat="server" Modal="True"
                ...
                <ContentTemplate>
                    <table style="text-align: center; width: 100%" cellpadding="5">
                        <tr>
                            <td>Bạn có chắc muốn xóa dữ liệu không?
                            </td>
                        </tr>
                        <tr>
                            <td>
