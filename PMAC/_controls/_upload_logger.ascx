<%@ Control Language="C#" AutoEventWireup="true" CodeFile="_upload_logger.ascx.cs" Inherits="_controls_upload_logger" %>
<style type="text/css">
...
<table class="auto-style1">
    ...
    <tr>
        <td>Chọn file</td>
        <td>
            <telerik:RadAsyncUpload ID="updLFiles" runat="server">
    ...
    <tr>
        <td>&nbsp;</td>
        <td>
            <telerik:RadButton ID="btnLUploadFile" runat="server" Text="Upload Files">
            </telerik:RadButton>
            <telerik:RadButton ID="btnLDownloadFiles" runat="server" Text="Download Files">
            </telerik:RadButton>
            <telerik:RadButton ID="btnLDeleteFiles" runat="server" Text="Xóa files">
            </telerik:RadButton>
        </td>
    </tr>
</table>
<telerik:RadGrid ID="grvLFiles" runat="server" AllowAutomaticDeletes="True" AllowPaging="True" AllowSorting="True" AutoGenerateDeleteColumn="True" CellSpacing="0" DataSourceID="TFilesDS" GridLines="None" PageSize="20">
...
<asp:SqlDataSource ID="LFilesDS" runat="server" ConnectionString="<%$ ConnectionStrings:DbConnectionString %>" DeleteCommand="DELETE FROM [t_Logger_Files] WHERE [FileID] = @FileID" InsertCommand="INSERT INTO [t_Logger_Files] ([FileName], [MIMEType], [Size], [UploadDate]) VALUES (@FileName, @MIMEType, @Size, @UploadDate)" SelectCommand="SELECT [FileID], [FileName], [MIMEType], [Size], [UploadDate] FROM [t_Logger_Files] WHERE ([LoggerSerial] = @LoggerSerial) ORDER BY [UploadDate], [FileName]" UpdateCommand="UPDATE [t_Logger_Files] SET [FileName] = @FileName, [MIMEType] = @MIMEType, [Size] = @Size, [UploadDate] = @UploadDate WHERE [FileID] = @FileID">
    <DeleteParameters>
    ...
    <SelectParameters>
        <asp:ControlParameter ControlID="cboLSeries" Name="LoggerSerial" PropertyName="SelectedValue" Type="String" />
    </SelectParameters>
    <UpdateParameters>
        <asp:Parameter Name="FileName" Type="String" />
        <asp:Parameter Name="MIMEType" Type="String" />
